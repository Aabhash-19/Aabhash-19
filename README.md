...
<p>
  <a href="https://github.com/Aabhash-19">
    <img src="https://img.shields.io/github/followers/Aabhash-19?label=Follow&style=for-the-badge&logo=github&logoColor=white" />
  </a>
...
Rather than limiting myself to notebooks and isolated models, I enjoy taking ideas through the **entire engineering lifecycle**:

> **Idea → System Design → ML Pipeline → Backend → Database → Frontend → Deployment**

My projects span **computer vision, NLP, semantic search, recommendation systems, assistive AI, generative AI, industrial ML, and interactive web applications**.

I particularly enjoy building products that make AI feel like an actual **feature of the application** rather than just a model running behind a button.
...
<a href="https://github.com/Aabhash-19/NamiVerse">
  <img src="https://img.shields.io/badge/VIEW_SOURCE-GITHUB-181717?style=for-the-badge&logo=github" />
</a>

</div>

**NamiVerse** is an AI-powered anime discovery ecosystem designed around intelligent exploration rather than traditional database browsing.
...
Turn a photo of a physical book into an intelligent digital discovery experience.

BookLens combines **computer vision, OCR, barcode recognition, semantic embeddings, external metadata retrieval and recommendation systems** to identify books and help users discover what to read next.
...
SmilePet turns real facial expressions into a gamified virtual-pet experience.

Users smile into their webcam, and the application evaluates facial geometry using **MediaPipe Face Mesh**. Smile scores generate **Smile Coins**, which can be used to care for and customize a virtual pixel pet.
...
<a href="https://github.com/Aabhash-19/SmilePet">
<img src="https://img.shields.io/badge/Source_Code-181717?style=for-the-badge&logo=github"/>
</a>

<a href="https://smile-pet.vercel.app">
<img src="https://img.shields.io/badge/Live_Demo-000000?style=for-the-badge&logo=vercel"/>
</a>
...
Plantix analyzes plant leaf images and helps identify potential diseases using **computer vision and multimodal AI**.
...
<a href="https://github.com/Aabhash-19/Plantix">
<img src="https://img.shields.io/badge/Source_Code-181717?style=for-the-badge&logo=github"/>
</a>

<a href="https://plantix.streamlit.app">
...
DivyaDrishti is an AI-powered assistive system designed to help visually impaired users understand their surroundings through **real-time object detection, currency recognition and audio feedback**.
...
<a href="https://github.com/Aabhash-19/DivyaDrishti">
<img src="https://img.shields.io/badge/Source_Code-181717?style=for-the-badge&logo=github"/>
</a>
...
**PaperPilot AI** explores how machine learning can support industrial decision-making.

The system is designed around predicting **paper-quality deviations during grade changes**, analyzing possible root causes, and recommending safer process adjustments to improve stability and reduce waste.
...
`PyTorch` • `MobileNetV4` • `CNNs` • `CIFAR-10` • `GPU Acceleration` • `Model Optimization`

<a href="https://github.com/Aabhash-19/MobileNetV4-AppleSilicon-Optimization">
<img src="https://img.shields.io/badge/View_Project-181717?style=flat-square&logo=github"/>
</a>
...
![Backend Architecture](https://img.shields.io/badge/Backend_Architecture-181717?style=for-the-badge)
...
I enjoy understanding **how the whole system fits together** instead of treating ML models, APIs, databases and interfaces as separate worlds.
...
<img src="https://streak-stats.demolab.com?user=Aabhash-19&theme=tokyonight&hide_border=true" />
...
It's everything around the model too.
...
Where is state stored?
           ↓
How does the API scale?
           ↓
How do recommendations improve?
           ↓
How is data represented?
           ↓
How does the frontend communicate with the model?
           ↓
How do we deploy the entire system reliably?
```

That's why many of my projects combine **machine learning + backend development + databases + modern frontend engineering**.
...
### Build software where AI isn't a gimmick.

### Build systems where AI makes the product genuinely better.

<br/>

`Machine Learning` × `Software Engineering` × `Product Thinking`
...
NamiVerse represents a lot of what I enjoy about engineering:
...
**AI/ML • Software Engineering • Open Source • Research • Interesting Projects**
...
║  AI Focus             │ ML • CV • NLP • Recommendations   ║
...
that generates the snake SVG into an "output" branch.
Once configured, uncomment the following lines:

<picture>
  <source
    media="(prefers-color-scheme: dark)"
    srcset="https://raw.githubusercontent.com/Aabhash-19/Aabhash-19/output/github-contribution-grid-snake-dark.svg"
  />
  <source
    media="(prefers-color-scheme: light)"
    srcset="https://raw.githubusercontent.com/Aabhash-19/Aabhash-19/output/github-contribution-grid-snake.svg"
  />
  <img
    alt="github contribution grid snake animation"
    src="https://raw.githubusercontent.com/Aabhash-19/Aabhash-19/output/github-contribution-grid-snake.svg"
  />
</picture>
-->
...
<a href="https://github.com/Aabhash-19?tab=repositories">
